...
const Footer = () => {
  return (
    <div className="w-full pt-24 pb-12 bg-slate-800">
        ...
        <div className="flex flex-wrap">
          ...
          <div class="w-full px-4 mb-12 text-slate-300 md:w-1/3 flex flex-col md:flex-row gap-8">
            <div>
              ...
              <p className="md:text-center">Student Registered</p>
            </div>
            <div>
              <h3 class="font-bold text-2xl mb-2 md:text-center">200</h3>
              <p className="md:text-center">Teacher Registered</p>
            </div>
            <div>
              <h3 class="font-bold text-2xl mb-2 md:text-center">200</h3>
              <p className="md:text-center">School Registered</p>
            </div>
          </div>
        </div>
